...
public static class Setup
{
      [MenuItem("Tools/Setup/Create Default Folders")]
        ...
        [MenuItem("Tools/Setup/Import My Favorite Unity Assets")]
        public static void ImportMyFavoriteUnityAssets() {
        ...
        [MenuItem("Tools/Setup/Install Unity XR kit")]
        public static void InstallUnityVR() {
            Packages.InstallPackages(new[] {
        ...
        [MenuItem("Tools/Setup/Install Meta XR kit")]
        public static void InstallMetaVR() {
            Packages.InstallPackages(new[] {
                "com.meta.xr.sdk.all"
            });
        }
        ...
        static class Assets {
            public static void ImportAsset(string asset, string subfolder,
                string rootFolder = "C:/Users/lants/AppData/Roaming/Unity/Asset Store-5.x") {
